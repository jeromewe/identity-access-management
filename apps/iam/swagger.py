...
def get_swagger_view(version='v1'):
    ...
    schema_view = get_schema_view(
        openapi.Info(
            title="Identity Management API Docs",
            default_version=version,
            description="Identity Management Restful api docs",
            terms_of_service="https://www.light2cloud.com",
            contact=openapi.Contact(email="support@light2cloud.com"),
