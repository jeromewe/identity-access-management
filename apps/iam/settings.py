...
EMAIL_CUSTOM_USER_CREATED_SIGNATURE = '光环有云'
...
SES_EMAIL_SENDER = CONFIG.SES_EMAIL_SENDER or 'dev@light2cloud.com'
SES_EMAIL_SENDERNAME = CONFIG.SES_EMAIL_SENDERNAME or '光环有云'
...
ADMINS = (
    ('admin', 'wenhaiji@light2cloud.com'),
)
# 凭证数量
